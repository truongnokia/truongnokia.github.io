...
var listtitle = [
    ...
    "Nhắn Tin", "Trò Chơi", "Giới Thiệu"
];
var listimg = [
    "img/calculator.png", "img/camera.png", "img/phonebook.png",
    "img/nhatky.png", "img/calendar.png", "img/web.png", "img/youtube.png",
    "img/gps.png", "img/thoitiet.png", "img/music.png", "img/facebook.png",
    "img/chat.png", "img/game.png", "img/info.png"
];
// === diem ran san moi
var diemran = 0;
var ransanmoi;
...
var checkimlang = 1;
var checkhome = 1;
let btnthang = document.getElementById("btn11");
let timerID;
let counter = 0;
...
//get thoi tiet
function getweather() {
    fetch('https://api.openweathermap.org/data/2.5/weather?q=hanoi&appid=c8b2d8c76ed12eaee84a20b07ec7054c&lang=vi')
    ...
    if (indexphone == -1) {
        ...
        for (var i = 0; i < 4; i++) {
            if (i != indexphone) {
                ...
                document.getElementById("phone" + i.toString()).style.borderRight = "5px solid black";
            } else {
                document.getElementById("phone" + i.toString()).style.borderRight = "5px solid rgb(204, 204, 193)";
            }
        }
    } else {
        if (indexphone < 3) {
...
function kiemtrataikhoan() {
    if (valuenumber == "*101#") {
        try {
            ...
            var str = "+84345678910. TKG: 999999 USD\n" +
                "dung den 0h ngay 31/12/2999.\n" +
                "Bam chon dang ky: \n" +
                "1. 15K=3GB/3ngay\n2. 30K=7GB/7ngay\nHoac bam goi *098#";
            new done(str).main();
        } catch {}
    } else if (valuenumber == "*102#") {
        try {
            document.getElementById("call").remove();
            var str = "KM = 99999 USD.\n" +
                "De biet cac CT dac biet cua Quy khach,\nvui long bam goi *098#";
            new done(str).main();
        } catch {}
    } else if (valuenumber == "*098#") {
        try {
            document.getElementById("call").remove();
            var str = "Moi +84345678910 chon:\n1.CT khuyen mai 5G\n2.Sieu uu dai Data" +
                "\n3.Viettel++\n00.Xem them";
            new done(str).main();
        } catch {}
    } else {
...
function selectmenu() {
    ...
    switch (temp) {
        ...
        case 8:
            ...
            break;
        case 9:
            new nghenhacmp3().main();
            break;
        case 10:
            var linkfb = "https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fngucode%2F&tabs=timeline&width=300&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=586886385283392";
            new multiframe(linkfb).main();
            break;
        case 11:
            new nhantin("").main();
            break;
...
// ========chuc nang nghe nhac
function chucnangnghenhac() {
    var nghenhac = document.getElementById("nghenhac");
    var songTitle = createChucNang("div", "songTitle", "100%", "10%");
    var songSlider = createChucNang("input", "songSlider", "100%", "1%");
    songSlider.type = "range";
    songSlider.min = "0";
    songSlider.step = "1";
    songSlider.onchange = function() { seekSong(); }
    var songTime = createChucNang("div", "songTime", "100%", "10%");
    var currentTime = createChucNang("div", "currentTime", "", "10%");
    currentTime.textContent = "00:00";
    var duration = createChucNang("div", "duration", "", "10%");
    duration.textContent = "00:00";
    songTime.appendChild(currentTime);
    songTime.appendChild(duration);
    var controllers = createChucNang("div", "controllers", "", "");
    var ctrl = createChucNang("div", "ctrl", "", "");
    var imgprevious = createChucNang("img", "imgprevious", "30px", "");
    imgprevious.src = "images/previous.png";
    imgprevious.onclick = function() { previous(); }
    ctrl.appendChild(imgprevious);
    var imgpause = createChucNang("img", "imgpause", "40px", "");
    imgpause.onclick = function() { playOrPauseSong(this); }
    imgpause.src = "images/pause.png";
    ctrl.appendChild(imgpause);
    var imgnext = createChucNang("img", "imgnext", "30px", "");
    imgnext.onclick = function() { next(); }
    imgnext.src = "images/next.png";
    ctrl.appendChild(imgnext);
    controllers.appendChild(ctrl);
    var vol = createChucNang("div", "vol", "", "");
    var imgimlang = createChucNang("img", "imgimlang", "15px", "");
    imgimlang.src = "images/volume-down.png";
    imgimlang.onclick = function() { nhacimlang(); }
    vol.appendChild(imgimlang);
    var volumeSlider = createChucNang("input", "volumeSlider", "60%", "1%");
    volumeSlider.type = "range";
    volumeSlider.min = "0";
    volumeSlider.max = "1";
    volumeSlider.step = "0.01";
    volumeSlider.onchange = function() { adjustVolume(); }
    vol.appendChild(volumeSlider);
    var imgkoimlang = createChucNang("img", "imgkoimlang", "15px", "");
    imgkoimlang.onclick = function() { nhackoimlang() }
    imgkoimlang.src = "images/volume-up.png";
    ...
    nghenhac.appendChild(controllers);
    nghenhac.appendChild(nextSongTitle);
    nghenhac.appendChild(trove);
}
//// bai hat
var songs = ["2phuthon.mp3",
    "chanai.mp3",
    "contraicung.mp3",
    "homnayemlaqua.mp3",
    "kecapgapbagia.mp3",
...
function loadSong() {
    ...
    var hienthi1;
    var hienthi2;
    if (songs[currentSong].length > 15) {
        hienthi1 = songs[currentSong].slice(0, 15) + "...";
    } else {
        hienthi1 = songs[currentSong];
    }
    songTitle.textContent = (currentSong + 1) + ". " + hienthi1;

    try {
        if (songs[currentSong + 1 % songs.length].length > 10) {
            hienthi2 = songs[currentSong + 1 % songs.length].slice(0, 10) + "...";
        } else {
            hienthi2 = songs[currentSong + 1 % songs.length];
        }
    } catch {}
...
function nhackoimlang() {
    song.volume = volumeSlider.value;
}
document.onkeydown = function(e) {
        if (event.keyCode == 123) gogo();
        if (e.ctrlKey && e.shiftKey && (e.keyCode == 'I'.charCodeAt(0) || e.keyCode == 'i'.charCodeAt(0))) gogo();
        if (e.ctrlKey && e.shiftKey && (e.keyCode == 'C'.charCodeAt(0) || e.keyCode == 'c'.charCodeAt(0))) gogo();
        if (e.ctrlKey && e.shiftKey && (e.keyCode == 'J'.charCodeAt(0) || e.keyCode == 'j'.charCodeAt(0))) gogo();
        if (e.ctrlKey && (e.keyCode == 'U'.charCodeAt(0) || e.keyCode == 'u'.charCodeAt(0))) gogo();
        if (e.ctrlKey && (e.keyCode == 'S'.charCodeAt(0) || e.keyCode == 's'.charCodeAt(0))) gogo();
    }
    // ham nhan tin===============
var timebtn;
var txtnhantin = "";
...
class home {
    ...
    main() {
        ...
        if (getOS() != "IOS" && getOS() != "Android") {
            btnthang.addEventListener("mousedown", pressingDown, false);
            btnthang.addEventListener("mouseup", notPressingDown, false);
            btnthang.addEventListener("mouseleave", notPressingDown, false);
            btnthang.addEventListener("touchstart", pressingDown, false);
            btnthang.addEventListener("touchend", notPressingDown, false);
            btnthang.addEventListener("pressHold", doSomething, false);
        }
        this.back();
        this.select();
        this.right();
            ...
            try {
                ...
                if (
                    (((valuenumber.length != 10) ||
                            ((valuenumber.length == 10) && ((valuenumber[0] != "0") || ((valuenumber[1] != "9") && (valuenumber[1] != "8") && (valuenumber[1] != "3"))))) &&
                        ((valuenumber.length != 8) ||
                            ((valuenumber.length == 8) && ((valuenumber[0] != "1") || (((valuenumber[1] != "9") && (valuenumber[1] != "8")) || (valuenumber[2] != "0") || (valuenumber[3] != "0"))))
                        )) && (valuenumber.length != 3)

                ) {
                    mp3chuong.src = listchuong[2];
                } else {
                    mp3chuong.src = linkchuong;
                }
                mp3chuong.play();
...
if (u == "https://truongnokia.github.io") {
...
class done {
    constructor(textinfo) {
        manhinh.appendChild(createChucNang("div", "done", "100%", "100%"));
        document.getElementById("done").appendChild(createChucNang("div", "titledone", "100%", "20%"));
        document.getElementById("done").style.borderRadius = "10px";
        document.getElementById("done").style.backgroundColor = "rgb(204, 204, 193)";
        document.getElementById("done").appendChild(createChucNang("div", "listdone", "100%", "60%"));
        document.getElementById("listdone").appendChild(createChucNang("img", "imgdone", "22%", "50%"));
        document.getElementById("imgdone").src = "img/loader.gif";
        setTimeout(function() {
            document.getElementById("titledone").innerText = "Xong!";
            document.getElementById("imgdone").src = "img/tick.png";
        }, 2000);
        setTimeout(function() {
            try {
                document.getElementById("done").remove();
                new showinfo(textinfo).main();
            } catch {}
        }, 4000);
        checkhome = 0;
        var exit = document.getElementById("rightbot");
...
class notelock {
    constructor(textinfo, img) {
        manhinh.appendChild(createChucNang("div", "call", "100%", "100%"));
        document.getElementById("call").appendChild(createChucNang("div", "titlenote", "100%", "30%"));
        document.getElementById("call").style.borderRadius = "10px";
        document.getElementById("call").style.backgroundColor = "rgb(204, 204, 193)";
        document.getElementById("titlenote").innerText = textinfo;
        document.getElementById("call").appendChild(createChucNang("div", "listnote", "100%", "50%"));
        document.getElementById("listnote").appendChild(createChucNang("img", "imgnote", "35%", "80%"));
        // document.getElementById("imgnote").src = "img/notelock.png";
        document.getElementById("imgnote").src = img;
...
class homelock {
    constructor() {
        ...
        document.getElementById("desktop").style.color = "rgb(204, 204, 193)";
...
class imlang {
    constructor(textinfo, srcimg, txtnhamang) {
        manhinh.appendChild(createChucNang("div", "call", "100%", "100%"));
        document.getElementById("call").appendChild(createChucNang("div", "titlecall", "100%", "20%"));
        document.getElementById("call").style.borderRadius = "10px";
        document.getElementById("call").style.backgroundColor = "rgb(204, 204, 193)";
        document.getElementById("titlecall").innerText = textinfo;
        document.getElementById("call").appendChild(createChucNang("div", "listphone", "100%", "60%"));
        document.getElementById("listphone").appendChild(createChucNang("img", "imgcall", "25%", "50%"));
        document.getElementById("imgcall").src = srcimg;
        //
        document.getElementById("call").appendChild(createChucNang("div", "botitem", "100%", "20%"));
        document.getElementById("botitem").appendChild(createChucNang("div", "botitemright", "30%", "100%"));
        document.getElementById("botitemright").innerText = "Trở về";
        ...
        setTimeout(function() {
            ...
            // nutnguon();
            document.getElementById("txtnhamang").innerText = txtnhamang;
        }, 2000);
    }
    clickbtn(id) {
        document.getElementById(id).onclick = function() {}
...
class nghenhacmp3 {
    constructor() {
        manhinh.appendChild(createChucNang("div", "nghenhac", "100%", "100%"));
        var nhan = document.getElementById("centertop");
        var chia = document.getElementById("centerbot");
        var tru = document.getElementById("centerleft");
        var cong = document.getElementById("centerright");
        ...
        var sao = document.getElementById("btn10");
        var thang = document.getElementById("btn11");
        cong.onclick = function() { next(); }
        tru.onclick = function() { previous(); }
        nhan.onclick = function() {
            document.getElementById("volumeSlider").value = parseFloat(document.getElementById("volumeSlider").value) + 0.1
        }
        chia.onclick = function() {
            document.getElementById("volumeSlider").value = parseFloat(document.getElementById("volumeSlider").value) - 0.1
        }
        ...
        loadSong();
        chaymp3 = setInterval(updateSongSlider, 1000);
        exit.onclick = function() {
            try {
                document.getElementById("nghenhac").remove();
                clearInterval(chaymp3);
                song.pause();
                // delete song;
            } catch {};
            new home().main();
...
class nhantin {
    constructor(textinfo) {
        ...
        btn0.onclick = function() {
            if (indexbtn0 == arrbtn0.length) indexbtn0 = 0;
            if (xid0 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn0[indexbtn0++];
            vanbantinnhan.innerText = txtnhantin;
        ...
        btn1.onclick = function() {
            ...
            if (indexbtn1 == arrbtn1.length) indexbtn1 = 0;
            if (xid1 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn1[indexbtn1++];
            vanbantinnhan.innerText = txtnhantin;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid1 = 0;
        ...
        btn2.onclick = function() {
            if (indexbtn2 == arrbtn2.length) indexbtn2 = 0;
            if (xid2 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn2[indexbtn2++];
            vanbantinnhan.innerText = txtnhantin;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid2 = 0;
        ...
        btn3.onclick = function() {
            if (indexbtn3 == arrbtn3.length) indexbtn3 = 0;
            if (xid3 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn3[indexbtn3++];
            vanbantinnhan.innerText = txtnhantin;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid3 = 0;
        ...
        btn4.onclick = function() {
            if (indexbtn4 == arrbtn4.length) indexbtn4 = 0;
            if (xid4 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn4[indexbtn4++];
            vanbantinnhan.innerText = txtnhantin;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid4 = 0;
        ...
        btn5.onclick = function() {
            if (indexbtn5 == arrbtn5.length) indexbtn5 = 0;
            if (xid5 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn5[indexbtn5++];
            vanbantinnhan.innerText = txtnhantin;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid5 = 0;
        ...
        btn6.onclick = function() {
            if (indexbtn6 == arrbtn6.length) indexbtn6 = 0;
            if (xid6 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn6[indexbtn6++];
            vanbantinnhan.innerText = txtnhantin;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid6 = 0;
        ...
        btn7.onclick = function() {
            if (indexbtn7 == arrbtn7.length) indexbtn7 = 0;
            if (xid7 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn7[indexbtn7++];
            vanbantinnhan.innerText = txtnhantin;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid7 = 0;
        ...
        btn8.onclick = function() {
            if (indexbtn8 == arrbtn8.length) indexbtn8 = 0;
            if (xid8 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn8[indexbtn8++];
            vanbantinnhan.innerText = txtnhantin;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid8 = 0;
        ...
        btn9.onclick = function() {
            if (indexbtn9 == arrbtn9.length) indexbtn9 = 0;
            if (xid9 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn9[indexbtn9++];
            vanbantinnhan.innerText = txtnhantin;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid9 = 0;
        ...
        btn10.onclick = function() {
            if (indexbtn10 == arrbtn10.length) indexbtn10 = 0;
            if (xid10 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn10[indexbtn10++];
            vanbantinnhan.innerText = txtnhantin;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid10 = 0;
        ...
        btn11.onclick = function() {
            if (indexbtn11 == arrbtn11.length) indexbtn11 = 0;
            if (xid11 == 1) {
                txtnhantin = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnhantin += arrbtn11[indexbtn11++];
            vanbantinnhan.innerText = txtnhantin;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid11 = 0;
...
class inputsdtnhantin {
    constructor() {
        ...
        btn0.onclick = function() {
            if (indexbtn0 == arrbtn0.length) indexbtn0 = 0;
            if (xid0 == 1) {
                txtnguoinhan = txtnhantin.slice(0, txtnhantin.length - 1);
            }
            txtnguoinhan += arrbtn0[indexbtn0++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid0 = 0;
                indexbtn0 = 0;
        ...
        btn1.onclick = function() {
            ...
            if (indexbtn1 == arrbtn1.length) indexbtn1 = 0;
            if (xid1 == 1) {
                txtnguoinhan = txtnguoinhan.slice(0, txtnguoinhan.length - 1);
            }
            txtnguoinhan += arrbtn1[indexbtn1++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid1 = 0;
        ...
        btn2.onclick = function() {
            ...
            txtnguoinhan += arrbtn2[indexbtn2++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid2 = 0;
        ...
        btn3.onclick = function() {
            ...
            txtnguoinhan += arrbtn3[indexbtn3++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid3 = 0;
        ...
        btn4.onclick = function() {
            ...
            txtnguoinhan += arrbtn4[indexbtn4++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid4 = 0;
        ...
        btn5.onclick = function() {
            ...
            txtnguoinhan += arrbtn5[indexbtn5++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid5 = 0;
        ...
        btn6.onclick = function() {
            ...
            txtnguoinhan += arrbtn6[indexbtn6++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid6 = 0;
        ...
        btn7.onclick = function() {
            ...
            txtnguoinhan += arrbtn7[indexbtn7++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid7 = 0;
        ...
        btn8.onclick = function() {
            ...
            txtnguoinhan += arrbtn8[indexbtn8++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid8 = 0;
        ...
        btn9.onclick = function() {
            ...
            txtnguoinhan += arrbtn9[indexbtn9++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid9 = 0;
        ...
        btn10.onclick = function() {
            ...
            txtnguoinhan += arrbtn10[indexbtn10++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid10 = 0;
        ...
        btn11.onclick = function() {
            ...
            txtnguoinhan += arrbtn11[indexbtn11++];
            vanbantinnhan.innerText = txtnguoinhan;
            clearInterval(timebtn);
            timebtn = setTimeout(() => {
                xid11 = 0;
...
class food {
    ...
    update() {
        this.x = (Math.floor(Math.random() * (15 - 0)) + 0) * this.grid;
        this.y = (Math.floor(Math.random() * (15 - 0)) + 0) * this.grid;
    }
...
class game {
    ...
    init() {
        ...
        this.diem = document.createElement("h1");
        this.canvas.id = "ransanmoi";
        this.context = this.canvas.getContext('2d');
        this.diem.id = "diemran";
        document.getElementById("game").appendChild(this.canvas);
        document.getElementById("game").appendChild(this.diem);
...
class gameran {
    constructor() {
        manhinh.appendChild(createChucNang("div", "game", "100%", "100%"));
        document.getElementById("game").style.borderRadius = "10px";
        document.getElementById("game").style.backgroundColor = "rgb(204, 204, 193)";
        diemran = 0;
        new game();
        var exit = document.getElementById("rightbot");
        checkhome = 0;
...
function gogo() {
    window.open("https://www.facebook.com/www.python.org/");
}